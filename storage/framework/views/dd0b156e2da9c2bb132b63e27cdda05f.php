...
<body>
    ...
    <form action="<?php echo e(route('items.update', $item['id'])); ?>" method="POST">
        ...
        <input type="text" id="apellido" name="apellido" value="<?php echo e($item['apellido']); ?>" required>
        <br>
...
<?php /**PATH C:\xampp\htdocs\CRUD\CRUD\crudLaravel9\resources\views/items/edit.blade.php ENDPATH**/ ?>